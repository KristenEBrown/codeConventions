...
## Packages
  ...
  For example, if you would like to create an application *`myApp`* as a part of Delta's IT department, the package name would be: `com.deltaairlines.it.myapp` and a class *`myClass`* inside this application would be: `com.deltaairlines.it.myapp.myClass`.  This would be located in your directory as `src/main/java/com/deltaairlines/it/myapp/myclass` and would compile into `target/classes/com/deltaairlines/it/myapp/myclass`.</br>
